...
namespace object {
    ...
    private:
        ...
        c3ga::Mvec<GLfloat> p1;
        c3ga::Mvec<GLfloat> p2;
        c3ga::Mvec<GLfloat> p3;
        c3ga::Mvec<GLfloat> p4;
    ...
    public:
        ...
        Sphere(c3ga::Mvec<GLfloat> multivector, GLuint64 longitude, GLuint64 latitude, GLfloat rayon = 1.0f, glm::vec3 center ={0.0f, 0.0f, 0.0f}, GLfloat rayorMax = 2.0f);
        ...
        c3ga::Mvec<GLfloat> getMultiVectors();
